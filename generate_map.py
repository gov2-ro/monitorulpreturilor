#!/usr/bin/env python3
"""
Generate dashboard/stores_map.html from data/prices.db.
Reads retail stores with network names and writes a self-contained Leaflet map.

Usage:
    python generate_map.py
    python generate_map.py --db data/prices.db --out dashboard/stores_map.html
"""
...
OUT_PATH = Path("dashboard/stores_map.html")
